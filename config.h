...
static const char* colors[NUMCOLORS][3] = {
	...
	{ normbordercolor, "#ffcc00",   normbgcolor },  // warning - yellow
	{ normbordercolor, "#ff0000",   normbgcolor },  // error - red
	{ normbordercolor, "#444444",   normbgcolor },  // delim - gray
...
static const char *dmenucmd[] = { "dmenu-my", "-fn", dmenufont, "-nb", normbgcolor, "-nf", normfgcolor, "-sb", selbgcolor, "-sf", selfgcolor, NULL };
static const char *exitdmenucmd[] = { "dmenu-exit", "-fn", dmenufont, "-nb", "#ff0000", "-nf", "#000000", "-sb", "#000000", "-sf", selfgcolor, NULL };
/* volume */
...
static Key keys[] = {
	...
	{ 0,                    XK_F1,                   spawn,          SHCMD("scratchpad") },
	...
	{ MODKEY,               XF86XK_AudioPlay,        spawn,          {.v = mpcstopcmd } },
	...
	{ 0,                    XF86XK_Display,          spawn,          SHCMD("x220_LVDS1.sh") },
	{ 0,                    XF86XK_TouchpadToggle,   spawn,          SHCMD("x220_touchpad_toggle.sh") },
